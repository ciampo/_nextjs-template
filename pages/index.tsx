...
const Home = () => (
  <div>
    ...
    <div className="w-full text-gray-700">
      <h1 className="m-0 w-full pt-20 leading-tight text-5xl text-center">Welcome to Next.js!</h1>
      ...
      <div className="flex justify-between max-w-4xl mt-20 mx-auto mb-10">
        ...
        >
          <h3 className="m-0 text-lg text-primary">Documentation &rarr;</h3>
        ...
        <a
          ...
          className="pt-4 px-4 pb-5 w-56 text-left no-underline border border-solid border-gray-500 hover:border-primary"
        >
          <h3 className="m-0 text-lg text-primary">Next.js Learn &rarr;</h3>
          <p className="m-0 pt-2 text-sm text-gray-700">
        ...
        <a
          ...
          className="pt-4 px-4 pb-5 w-56 text-left no-underline border border-solid border-gray-500 hover:border-primary"
        >
          <h3 className="m-0 text-lg text-primary">Examples &rarr;</h3>
          <p className="m-0 pt-2 text-sm text-gray-700">
